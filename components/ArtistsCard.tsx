...
const ArtistsCard: FC<{ item: ArtistType; index: number }> = ({
  item,
  index,
}) => {
  return (
    <Link
      ...
      className="cursor-pointer w-[240px] relative flex flex-col items-center p-5 h-[240px] rounded-[20px] bg-[#3B3B3B]"
    >
      <Image
      ...
      <Text>
        Total Sales: <span className="text-[16px] text-white">34.53 ETH</span>
      </Text>
